...
<div class="generic-container">
    ...
    <form:form method="POST" modelAttribute="book" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="address">Category</label>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="postalCode">Pages</label>
                <div class="col-md-7">
                    <form:input type="number" path="pages" id="pages" class="form-control input-sm" />
                    <div class="has-error">
                        <form:errors path="pages" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div>
